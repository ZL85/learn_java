...
public class OverwriteToString {
    public static void main(String[] args) {
        ...
        System.out.println(u1);  //com.learnjava_06.User1@3b07d329 User1{name='jerry', age=12}
        System.out.println(u1.toString());  //com.learnjava_06.User1@3b07d329 User1{name='jerry', age=12}
